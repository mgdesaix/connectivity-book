...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{amre\_net }\OtherTok{\textless{}{-}}\NormalTok{ mignette}\SpecialCharTok{::}\FunctionTok{net\_create}\NormalTok{(amre\_conn,}
                            \AttributeTok{node.names =} \FunctionTok{list}\NormalTok{(bnode\_names,wnode\_names),}
                            \AttributeTok{connected\_tol =} \FloatTok{0.01}\NormalTok{)}
...
\NormalTok{amre\_net}\SpecialCharTok{$}\NormalTok{display\_par}\SpecialCharTok{$}\NormalTok{bnode\_colors }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"\#009e73"}\NormalTok{, }\StringTok{"\#cc79a7"}\NormalTok{, }\StringTok{"\#56b4e9"}\NormalTok{, }\StringTok{"\#e69f00"}\NormalTok{, }\StringTok{"\#7979ff"}\NormalTok{)}
\NormalTok{amre\_net}\SpecialCharTok{$}\NormalTok{display\_par}\SpecialCharTok{$}\NormalTok{wnode\_colors }\OtherTok{\textless{}{-}} \StringTok{"grey80"}

\NormalTok{mignette}\SpecialCharTok{::}\FunctionTok{net\_draw}\NormalTok{(amre\_net)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{Mignette_files/figure-latex/unnamed-chunk-9-1.pdf}
