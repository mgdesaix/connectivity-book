...
The ecoregion data is provided by {[}provide link{]}. The ecoregions are provided in this this package as \texttt{ecoregions\_simple}. We will intersect the ecoregions with the nonbreeding range of the Common Yellowthroat to identify all the ecoregions that overlap with the nonbreeding range.
...
\hypertarget{finalize-nonbreeding-nodes}{%
\section{Finalize nonbreeding nodes}\label{finalize-nonbreeding-nodes}}
