...
\NormalTok{region.ids }\OtherTok{\textless{}{-}}\NormalTok{ conservation\_regions }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{as\_tibble}\NormalTok{() }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{select}\NormalTok{(Region) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{add\_column}\NormalTok{(}\StringTok{"Index"} \OtherTok{=} \DecValTok{1}\SpecialCharTok{:}\FunctionTok{nrow}\NormalTok{(conservation\_regions))}

\NormalTok{sampled\_conservation\_regions }\OtherTok{\textless{}{-}}\NormalTok{ terra}\SpecialCharTok{::}\FunctionTok{nearby}\NormalTok{(nonbreeding\_coords,}
\NormalTok{                                              conservation\_regions,}
                                              \AttributeTok{centroids =} \ConstantTok{FALSE}\NormalTok{,}
                                              \AttributeTok{k=}\DecValTok{1}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{as\_tibble}\NormalTok{() }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{left\_join}\NormalTok{(region.ids, }\AttributeTok{by =} \FunctionTok{c}\NormalTok{(}\StringTok{"k1"} \OtherTok{=} \StringTok{"Index"}\NormalTok{))}
