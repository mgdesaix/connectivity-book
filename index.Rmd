...
This text outlines how to create migratory networks using the R package `MuSpTest` (*We need a name!*). The creation of the migratory networks is broken into three main parts:
