...
Thus, we've identified the 5 nonbreeding nodes for the American Redstart data. We can plot these conservation regions along with the corresponding sampling points.
...
Now on to [Step 2: Abundance and migratory connectivity data](#wintering)
